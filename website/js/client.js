...
function updatePlayer(xPos) {
    ...
    if (room.queue.length == 0) {
        ...
        document.getElementById("point").style.background = "var(--pink)";
...
<div class="entry">
    <img class="thumbnail" src="${thumbnail}">
    <span class="video-title">${title}</span>
    <svg xmlns="http://www.w3.org/2000/svg" onclick="${fun}('${id}')" class="add-button" viewBox="0 0 24 24"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/><path d="M0 0h24v24H0z" fill="none"/></svg>
</div>`;
}
